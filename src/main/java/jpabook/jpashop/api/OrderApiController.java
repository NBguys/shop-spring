...
public class OrderApiController {
    ...
    public List<OrderQueryDto> ordersV6() {
        ...
        collect.forEach((orderQueryDto, orderItemQueryDtos) -> {
                    System.out.println("orderId = " + orderQueryDto.getOrderId());
                    orderItemQueryDtos.forEach(item -> System.out.println("item.getItemName() = " + item.getItemName()));
                }
        );

        List<OrderQueryDto> collected = collect.entrySet().stream()
